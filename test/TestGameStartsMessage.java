...
public class TestGameStartsMessage
{
    ...
    {
        String s = "{\"message_type\": \"GAME_STARTS\", \"player_id\": 0, \"players_info\": [ { \"player_id\": 0, \"nickname\": \"jugador\", \"remote_address\": \"127.0.0.1:59840\", \"is_connected\": true } ], \"nb_players\": 4, \"nb_special_players\": 0, \"nb_turns_max\": 100, \"milliseconds_before_first_turn\": 1000, \"milliseconds_between_turns\": 1000, \"initial_game_state\": {}}";
        ...
        assertEquals(0, m.nbSpecialPlayers);
